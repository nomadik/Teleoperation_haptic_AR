...
class Visualiser:
    ...
    def update_plot(self,frame):
        ...
        if x_index <self.maxt/2 or np.sin((x_index2/fs)*2*np.pi*f/100)*7>0:
        ...
        if self.y_desired_data[x_index-1]>=self.y_desired_data[x_index]:
            msg2.y_desired = self.y_desired_data[x_index]
        else:
            msg2.y_desired = abs(self.y_desired_data[x_index])
